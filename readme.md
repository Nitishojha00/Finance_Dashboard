...
* **Line Chart**
  ...
  * Time filters: 3D, 7D, 30D, 2M, 3M, 1Y
* **Doughnut Chart**
...
* Displays a **Period Summary Card**:
...
* Uses a callback system:
  ...
  * `setRefreshCallback()` → re-renders UI
...
* `getFilteredSortedTransactions()`
  ...
  * Handles search, filters, sorting
* `getTotalsForRange()`

  * Computes custom range summary
* Input validation:
